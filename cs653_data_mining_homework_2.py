...
def main():
    ...
    # Question 1: Generate histograms of the 11 ratings for each of the datasets and write down observations
    
    # Import winequality-red.csv and winequality-white.csv datasets
    red_wine_quality = pd.read_csv('winequality-red.csv', sep=';', header=0)
    white_wine_quality = pd.read_csv('winequality-white.csv', sep=';', header=0)
    
    # Questions 2: Generate box plots of the 11 ratings for each of the datasets and write down observations
    
    # Create histograms of the 11 ratings for each of the data sets
    create_histo(red_wine_quality, 'red_wine')
    create_histo(white_wine_quality, 'white_wine')
